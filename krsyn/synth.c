...
KS_INLINE i16 ks_apply_panpot(i16 in, i16 pan){
    i32 out = in;
    out *= pan;
    out >>= KS_OUTPUT_BITS;
    return out;
...
static KS_INLINE void ks_synth_process(const ks_synth* synth, ks_synth_note* note, u32 volume, u32 pitchbend, i16* buf, u32 len,
