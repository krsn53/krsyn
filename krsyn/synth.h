...
#define calc_phase_fines(value)                         ks_linear_u(ks_v(value,(8-4))-128, 0, ks_1(KS_PHASE_FINE_BITS - 8))
...
#define calc_lfo_freq(value)                            ks_exp_u(ks_v(value, (8-4)), ks_1(KS_FREQUENCY_BITS), 5)
